...
class CTkDatePicker(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.configure(fg_color="#a6b985")

        self.date_entry = ctk.CTkEntry(self, font=ctk.CTkFont(size=13, weight="bold"),
                                placeholder_text="YYYY-MM-DD", width=200)
        self.date_entry.grid(row=0, column=0, sticky="ew", padx=5, pady=5)

        self.calendar_button = ctk.CTkButton(self, fg_color="#648a64", text="▼", width=20,
                                            hover_color="#213435",command=self.open_calendar)
    ...
    def build_calendar(self):
        ...
        self.calendar_frame = ctk.CTkFrame(self.popup, fg_color="#a6b985")
        ...
        if self.allow_change_month:
            prev_month_button = ctk.CTkButton(self.calendar_frame, fg_color="#46685b",text="<", width=5, 
                                            hover_color="#213435", command=self.prev_month)
            prev_month_button.grid(row=0, column=0)

            next_month_button = ctk.CTkButton(self.calendar_frame, fg_color="#46685b", text=">", width=5, 
                                            hover_color="#213435", command=self.next_month)
